...
import de.xwic.appkit.core.config.editor.EDateTime;
...
public class EDateBuilder extends Builder<EDate> {
	...
	public IControl buildComponents(EDate eDate, IControlContainer parent, IBuilderContext context) {
		DatePicker datePicker = new DatePicker(parent);
		...
		context.registerField(eDate.getProperty(), datePicker, eDate, InputboxMapper.MAPPER_ID);
		return datePicker;
	}
