 ...
 * 
 */
package de.xwic.appkit.cluster.node.start;
...
import de.xwic.appkit.cluster.node.server.CNodeServer;

/**
 * Start the node as a stand-alone node. This will bring up the internally used
 * Jetty Server, to allow access to the node and allow HTTP based communication.
 * 
 * @author lippisch
 *
 */
public class Launch {
	...
	public static void main(String[] args) {
		...
		CNodeServer.FORCE_LOG4J_INITIALIZATION = true;
		
		System.out.println("XWic - CNode Launcher");
		System.out.println("---------------------");
		System.out.println();
		...
		CNodeServer server = CNodeServer.getInstance();
