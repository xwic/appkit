...
public final class DateFormatter {
	...
	private static final String formatDDMMYYYY = "dd-MM-yyyy";
	...
	private static final String formatMD = "MM/dd";
	...
	private static final String formatMDYNoSeparator = "MMddyyyy";
	...
	private static final String formatDMYTimeSecondsNoSeparator = "ddMMMyyyy_HHmmss";
	...
	private static final String formatDateTimeMillisecondsNoSpaces = "yyyyMMddHHmmssSSS";
	 ...
	 * @return
	 */
	public static DateFormat getDMYByGeo(String geoKey) {
		if (isAmerican(geoKey)) {
			return DateFormatter.getMDY();
		}
		
		return DateFormatter.getDMY();
	}
	 ...
	 * @return
	 */
	public static DateFormat getDMByGeo(String geoKey) {
		if (isAmerican(geoKey)) {
			return DateFormatter.getMD();
		}
		
		return DateFormatter.getDM();
	}
	 ...
	 * @return
	 */
	private static boolean isAmerican(String geoKey) {
		return "AMER".equalsIgnoreCase(geoKey) || "USPS".equalsIgnoreCase(geoKey);
	}
	 ...
	 * @return
	 */
	public static DateFormat getDateMMFormat() {
		return new SimpleDateFormat(formatDDMMYYYY);
	}
	/**
	 * @return
	 */
	...
	public static DateFormat getMD() {
		return new SimpleDateFormat(formatMD);
	}
	 ...
	 * @return
	 */
	public static DateFormat getMDYNoSeparator() {
		return new SimpleDateFormat(formatMDYNoSeparator);
	}
	 ...
	 * @return
	 */
	public static DateFormat getDMYTimeSecondsNoSeparator(TimeZone tz) {
		SimpleDateFormat df = new SimpleDateFormat(formatDMYTimeSecondsNoSeparator);
	 ...
	 * @return
	 */
	public static DateFormat getDateTimeMillisecondsNoSpaces(TimeZone tz) {

		SimpleDateFormat df = new SimpleDateFormat(formatDateTimeMillisecondsNoSpaces);
