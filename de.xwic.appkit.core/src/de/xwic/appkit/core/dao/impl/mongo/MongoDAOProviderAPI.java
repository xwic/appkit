...
public class MongoDAOProviderAPI implements DAOProviderAPI {
    ...
    public IEntity getEntity(Class<? extends Object> clazz, int id) throws DataAccessException {
        Datastore datastore = MongoUtil.getDatastore(clazz, mongoClient);
        Query<EntityWrapper> entityWrappers = datastore.find(EntityWrapper.class, "_id", id);
...
//        	ex.printStackTrace();
//        }
        Datastore datastore = MongoUtil.getDatastore(e.getClass(), mongoClient);
        EntityWrapper<IEntity> entityWrapper = new EntityWrapper<IEntity>(datastore);
        entityWrapper.setId(e.getId());
        entityWrapper.setEntity(e);
        Key< EntityWrapper<IEntity>> entityWrapperKey = datastore.save(entityWrapper);
